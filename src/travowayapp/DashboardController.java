...
public class DashboardController implements Initializable {
    ...
    @FXML
    private TableColumn<TravelData, String> availableB_col_busID;

    @FXML
    private TableColumn<TravelData, String> availableB_col_location;
...
//    LETS WORK FOR AVAILABLE BUSES FORM FIRST : ) 
    public void availableBusAdd() {
        ...
        String addData = "INSERT INTO bus (travel_id,location,status,price,date) VALUES(?,?,?,?,?)";
...
//                    TO UPDATE YOUR TABLE VIEW ONCE THE DATA IS SUCCESSFUL
    ...
    public void availableBusUpdate() {
        ...
        String updateData = "UPDATE bus SET location = '"
                ...
                + "' WHERE travel_id = '" + availableB_busID.getText() + "'";
...
//            NOW LETS PROCEED TO BOOKING TICKET : ) 
    ...
    public ObservableList<TravelData> availableBusBusData() {

        ObservableList<TravelData> busListData = FXCollections.observableArrayList();
        ...
        try {
            ...
            while (result.next()) {
                travelData = new TravelData(result.getInt("travel_id"),
                        result.getString("location"),
                        result.getString("status"),
                        result.getDouble("price"),
                        result.getDate("date"));

                busListData.add(travelData);
            }
    ...
    private ObservableList<TravelData> availableBBusListData;

    public void availableBShowBusData() {

        availableBBusListData = availableBusBusData();

        availableB_col_busID.setCellValueFactory(new PropertyValueFactory<>("travelId"));
    ...
    public void avaialbleBSelectBusData() {
        ...
        TravelData travelData = availableB_tableView.getSelectionModel().getSelectedItem();
        ...
        availableB_busID.setText(String.valueOf(travelData.getBusId()));
        availableB_location.setText(travelData.getLocation());
        availableB_price.setText(String.valueOf(travelData.getPrice()));
        availableB_date.setValue(LocalDate.parse(String.valueOf(travelData.getDate())));

    }
    
    public void availableSearch(){
        
        FilteredList<TravelData> filter = new FilteredList<>(availableBBusListData, e-> true);
...
//                    NOTE, IF INTEGER OR IF THE DATA TYPE IS NOT STRING, YOU MUST BE DO toString()
    ...
    public void travelIdList(){
        ...
        String travelData = "SELECT * FROM travel WHERE status = 'Available'";
        
        connect = Database.connectDb();
        
        try{
            prepare = connect.prepareStatement(travelData);
            result = prepare.executeQuery();
            ...
            bookingTicket_travelId.setItems(listB);
    ...
    public void LocationList(){
        ...
        String locationL = "SELECT * FROM travel WHERE status = 'Available'";
...
//    NOW LETS CREATE TABLE FOR customer
    ...
    public void bookingTicketSelect(){
        ...
        String travelId = (String)bookingTicket_travelId.getSelectionModel().getSelectedItem();
        ...
        if(firstName == null || lastName == null 
            ...
            String totalPrice = "SELECT price FROM travel WHERE location = '"
                    +location+"'";
            ...
            bookingTicket_sci_busID.setText(travelId);
    ...
    public void bookingTicketPay(){
        ...
        String travelId = bookingTicket_sci_busID.getText();
        ...
        String payData = "INSERT INTO customer (customer_id,firstName,lastName,gender,phoneNumber,travel_id,location,type,seatNum,total,date)"
                + " VALUES(?,?,?,?,?,?,?,?,?,?,?)";
...
//                WE NEED TO INSERT THE DATA ON CUSTOMER_RECEIPT FOR OUR RECEIPT : ) 
    ...
    public void bookingTicketReceipt(){
        ...
        hash.put("travelData", GetData.number);
...
//    NOW LETS PROCEED TO CUSTOMER FORM : ) 
    ...
    public void customersShowDataList(){
        ...
        customers_busID.setCellValueFactory(new PropertyValueFactory<>("travelId"));
